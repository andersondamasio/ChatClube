...
namespace com.chatclube.Widgets
{
    class Emoji
    {
        private static IDictionary<ulong, DrawableInfo> rects = new Dictionary<ulong, DrawableInfo>();
        private static int drawImgSize, bigImgSize;
        private static Boolean inited = Java.Lang.Boolean.False;
        private static Paint placeholderPaint;
        private static List<Bitmap> emojiBmp = new List<Bitmap>();
        private static List<Boolean> loadingEmoji = new List<Java.Lang.Boolean>();

        private static int[] cols = {
            13, 10, 15, 10, 14
        };

        private static int[] emojiChars = {
        ...
        private static void loadEmojiAsync(int page)
        {
            if (loadingEmoji[page] == Java.Lang.Boolean.True)
            {
                return;
            }
            loadingEmoji[page] = Java.Lang.Boolean.False; ;
    ...
    private static Boolean inArray(char c, char[] a)
        ...
        private static Boolean inArray(int c, int[] a)
        {
            foreach (char cc in a)
            {
                if (cc == c)
        ...
        public class EmojiSpan : Android.Text.Style.ImageSpan
        {
        ...
        public class EmojiDrawable : Drawable
        {
            private DrawableInfo info;
            private bool fullSize = false;
            private static Paint paint = new Paint(PaintFlags.FilterBitmap | PaintFlags.AntiAlias);
